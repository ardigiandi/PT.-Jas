...
function Klien() {
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-0  mt-[150px]">
      ...
      <div className="flex flex-wrap justify-center gap-9 lg:gap-24  mt-9 px-0 md:px-14">
        <img src="/assets/dookki.png" alt="Dookki" className="lg:w-[160px] w-[120px]" />
        <img src="/assets/sulawesi_kemang.png" alt="Sulawesi" className="lg:w-[160px] w-[120px]" />
        <img src="/assets/caffetutti.png" alt="Tutti" className="lg:w-[160px] w-[120px]" />
        <img src="/assets/sabore.png" alt="Sabore" className="lg:w-[160px] w-[120px]" />
        <img src="/assets/latteria.png" alt="Latteria" className="lg:w-[160px] w-[120px]" />
        <img src="/assets/kikkoman.png" alt="Kikkoman" className="lg:w-[160px] w-[120px]" />
